...
Engine=ReplicatedMergeTree('/clickhouse/tables/shard1/users_views', 'replica_1') PARTITION BY movie_duration ORDER BY id;
...
Engine=ReplicatedMergeTree('/clickhouse/tables/shard2/users_views', 'replica_2') PARTITION BY movie_duration ORDER BY id;
