...
class ClickHouseClient:
    def __init__(self) -> None:
        self.client = Client(host=config.clickhouse_host)
    ...
    def add_user_stamp(
        ...
        self.client.execute(f"""INSERT INTO 
                                ...
                                VALUES 
                                (generateUUIDv4(), '{user_id}', '{movie_id}', '{movie_duration}', {timestamp})""")
        
        self.logger.info(event=f'сохранили в кликхаус', data=f'{user_id} {movie_id} {movie_duration} {timestamp}')
    ...
    def add_test_timestamps(self):
        ...
        for e in range(1, 100):
            self.add_user_stamp(
                ...
                movie_id=f'movie_uid_{e}',
                movie_duration=random.randint(6000, 12000),
                timstamp=random.randint(1, 12000)
            )
